Q) Standard OS networking stacks manage protocol headers automatically. In this task, you will bypass the stack to manually "forge" a packet with intentional errors to observe how network layers respond to corruption. Create a C raw socket program to: [20 marks]
