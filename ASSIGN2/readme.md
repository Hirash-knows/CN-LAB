Q2: Network performance fluctuates under congestion. You are required to analyze how multiple concurrent TCP streams compete for bandwidth on a mininet link.  [20 marks]
